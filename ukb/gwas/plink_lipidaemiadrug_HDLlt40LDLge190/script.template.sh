...
plink2 --logistic \
       ...
       --pheno ../regenie_lipidaemiadrug_HDLlt40LDLge190/ukb_lipidaemiadrug_HDLlt40LDLge190_BT.txt \
       --pheno-name ${p} \
       --1 \
       --covar ../regenie_lipidaemiadrug_HDLlt40LDLge190/ukb_lipidaemiadrug_HDLlt40LDLge190_covariates.txt \
