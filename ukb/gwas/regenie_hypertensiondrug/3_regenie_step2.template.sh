...
regenie \
  ...
  --phenoFile ukb_hypertensiondrug_BT.txt \
  --covarFile ukb_hypertensiondrug_covariates.txt \
  --bt \
  --firth --approx --pThresh 0.01 \
  --pred ukb_hypertensiondrug_step1_BT_pred.list \
  --bsize 400 \
  --threads 8 \
  --out ukb_hypertensiondrug_step2_BT_chr${c}
