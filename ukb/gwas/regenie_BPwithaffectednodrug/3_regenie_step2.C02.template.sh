...
regenie \
  ...
  --covarFile ukb_BPwithaffectednodrug_covariates.txt \
  --catCovarList C02,C03,C07,C08,C09,affectednodrug \
  --qt \
  --pred ukb_BPwithaffectednodrug_step1_QT_pred.list \
  --bsize 400 \
  --threads 8 \
  --interaction C02[0] \
  --out ukb_BPwithaffectednodrug.C02_step2_QT_chr${c}
