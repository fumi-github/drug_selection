...
regenie \
  ...
  --keep ../qc_pass.id \
  --phenoFile ukb_antihypertensive.SBPmyboxcoxv2_QT.txt \
  --covarFile ukb_antihypertensive.SBP_covariates.txt \
  --qt \
  --bsize 1000 \
  --lowmem \
  --lowmem-prefix /labs/workspace/users/ftakeuchi/regenie_tmp11_preds \
  --threads 8 \
  --out ukb_antihypertensive.SBPmyboxcoxv2_step1_QT
