...
regenie \
  ...
  --phenoFile ukb_lipidaemiadrug_exclsupplement_BT.txt \
  --covarFile ukb_lipidaemiadrug_exclsupplement_covariates.txt \
  --bt \
  --firth --approx --pThresh 0.01 \
  --pred ukb_lipidaemiadrug_exclsupplement_step1_BT_pred.list \
  --bsize 400 \
  --threads 8 \
  --out ukb_lipidaemiadrug_exclsupplement_step2_BT_chr${c}
