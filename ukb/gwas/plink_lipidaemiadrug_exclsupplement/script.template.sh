...
plink2 --logistic \
       ...
       --pheno ../regenie_lipidaemiadrug_exclsupplement/ukb_lipidaemiadrug_exclsupplement_BT.txt \
       --pheno-name ${p} \
       --1 \
       --covar ../regenie_lipidaemiadrug_exclsupplement/ukb_lipidaemiadrug_exclsupplement_covariates.txt \
