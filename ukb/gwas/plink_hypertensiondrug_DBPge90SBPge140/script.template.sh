...
plink2 --logistic \
       ...
       --pheno ../regenie_hypertensiondrug_DBPge90SBPge140/ukb_hypertensiondrug_DBPge90SBPge140_BT.txt \
       --pheno-name ${p} \
       --1 \
       --covar ../regenie_hypertensiondrug_DBPge90SBPge140/ukb_hypertensiondrug_DBPge90SBPge140_covariates.txt \
