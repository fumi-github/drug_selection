...
plink2 --logistic \
       ...
       --pheno ../regenie_lipidaemiadrug_affectedexclsupplement/ukb_lipidaemiadrug_affectedexclsupplement_BT.txt \
       --pheno-name ${p} \
       --1 \
       --covar ../regenie_lipidaemiadrug_affectedexclsupplement/ukb_lipidaemiadrug_affectedexclsupplement_covariates.txt \
