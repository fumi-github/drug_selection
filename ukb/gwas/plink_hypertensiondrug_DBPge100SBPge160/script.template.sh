...
plink2 --logistic \
       ...
       --pheno ../regenie_hypertensiondrug_DBPge100SBPge160/ukb_hypertensiondrug_DBPge100SBPge160_BT.txt \
       --pheno-name ${p} \
       --1 \
       --covar ../regenie_hypertensiondrug_DBPge100SBPge160/ukb_hypertensiondrug_DBPge100SBPge160_covariates.txt \
