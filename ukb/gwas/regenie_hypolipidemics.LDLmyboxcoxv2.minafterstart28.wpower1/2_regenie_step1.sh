...
regenie \
  ...
  --keep ../qc_pass.id \
  --phenoFile ukb_hypolipidemics.LDLmyboxcoxv2_QT.txt \
  --phenoColList=ezetimibe,fibrate,statin \
  --covarFile ukb_hypolipidemics.LDL_covariates.txt \
  --qt \
  --bsize 1000 \
  --lowmem \
  --lowmem-prefix /labs/workspace/users/ftakeuchi/regenie_tmp12_preds \
  --threads 8 \
  --out ukb_hypolipidemics.LDLmyboxcoxv2_step1_QT
